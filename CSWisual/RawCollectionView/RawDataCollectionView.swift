...
struct RawAnalysisCollectionView: UIViewRepresentable  {
    ...
    var cellColorAlt: UIColor = UIColor(red: CGFloat(210.0/255.0), green: CGFloat(210.0/255.0), blue: CGFloat(210.0/255.0), alpha: 1.0)
    ...
    class Coordinator: NSObject, UICollectionViewDataSource {
        ...
        init(rows: [[String]], headers: [String], cellColor: UIColor, cellColorAlt: UIColor) {
            self.rows = rows
            self.headers = headers
            print("rows: \(rows.count) headers:\(headers.count)")
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            if indexPath.column == 0 {
                cell.backgroundColor = UIColor(red: CGFloat(210.0/255.0), green: CGFloat(210.0/255.0), blue: CGFloat(210.0/255.0), alpha: 1.0)
                if indexPath.row > 0 {
